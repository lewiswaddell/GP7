...
CPP Farm Store already has strong products, a unique connection to Cal Poly Pomona, and an in-store experience that gives it an advantage over traditional retailers. The main opportunity is to make that experience easier for customers to access online. Our recommendations begin with creating one centralized website, followed by improving and promoting gift basket sales, and finally setting up analytics to measure customer behavior and performance.

Together, these recommendations create a more connected path from product discovery to purchase and future customer engagement. By improving its digital presence while keeping the local and community-focused identity that makes the Farm Store unique, CPP Farm Store can reach more customers, make shopping more convenient, and make better decisions as its omnichannel strategy grows.
...
-   [Presentation Slides](https://livecsupomona-my.sharepoint.com/:b:/g/personal/lewiswaddell_cpp_edu/IQDhsTgCs5L6TZTqfa0I0EeOAUeIiWr0yJYN6X3tdlcF0A8?e=h0qeeo)
